...
INFIXA ( 2 + 5 ) * 3 + 1 -> PREFIXA
INFIXA 2 + 5 * 3 + 1 -> PREFIXA
INFIXA ( a and ( b or ( not ( T and a ) ) ) ) -> PREFIXA
INFIXA ( a and ( b or ( not T and a ) ) ) -> PREFIXA
INFIXA ( a and ( b or not T and a ) ) -> PREFIXA
INFIXA ( a and b or not T and a ) -> PREFIXA
INFIXA a and b or not T and a -> PREFIXA
INFIXA ( ( F or a ) or b ) and ( a or ( b and b ) ) -> PREFIXA
INFIXA ( F or a or b ) and ( a or b and b ) -> PREFIXA
INFIXA F or a or b and a or b and b -> PREFIXA
INFIXA ( 12 - 9 ) / ( ( 23 + 5 ) * -2 ) -> PREFIXA
INFIXA ( 12 - 9 ) / ( 23 + 5 * -2 ) -> PREFIXA
INFIXA ( 12 - 9 ) / 23 + 5 * -2 -> PREFIXA
INFIXA 12 - 9 / ( 23 + 5 * -2 ) -> PREFIXA
INFIXA 12 - 9 / 23 + 5 * -2 -> PREFIXA
INFIXA ( ( x + 3 ) + ( 2 * y ) ) - ( ( 2 * y ) + ( 3 + x ) ) -> PREFIXA
INFIXA ( x + 3 + 2 * y ) - ( 2 * y + 3 + x ) -> PREFIXA
INFIXA x + 3 + 2 * y - 2 * y + 3 + x -> PREFIXA
INFIXA ( x + 12 ) + ( 12 + x ) -> PREFIXA
INFIXA ( x + 12 ) + 0 -> PREFIXA
INFIXA 0 + ( 12 + x ) -> PREFIXA
INFIXA ( x + 12 ) - ( 12 + x ) -> PREFIXA
INFIXA ( x + 12 ) - 0 -> PREFIXA
INFIXA ( x + 12 ) * ( 12 + x ) -> PREFIXA
INFIXA ( x + 12 ) * 0 -> PREFIXA
INFIXA 0 * ( 12 + x ) -> PREFIXA
INFIXA ( x + 12 ) * 1 -> PREFIXA
INFIXA 1 * ( 12 + x ) -> PREFIXA
INFIXA ( x + 12 ) / ( 12 + x ) -> PREFIXA
INFIXA ( x + 12 ) / 1 -> PREFIXA
INFIXA 0 / ( 12 + x ) -> PREFIXA
INFIXA ( ( T == c ) or d ) and e -> PREFIXA
INFIXA ( T == ( c or d ) ) and e -> PREFIXA
INFIXA T == ( c or d and e ) -> PREFIXA
INFIXA T == c or d and e -> PREFIXA
INFIXA aa and ( bb or ( cc == T ) ) -> PREFIXA
INFIXA aa and ( ( bb or cc ) == T ) -> PREFIXA
INFIXA ( aa and bb or cc ) == T -> PREFIXA
INFIXA aa and bb or cc == T -> PREFIXA
INFIXA ( ( ( a / b ) * c ) - d ) + e -> PREFIXA
INFIXA ( ( a / b * c ) - d ) + e -> PREFIXA
INFIXA ( a / b * c - d ) + e -> PREFIXA
INFIXA a / b * c - d + e -> PREFIXA
INFIXA a / b * c - ( d + e ) -> PREFIXA
...
INFIXA ( a1 + ( b2 - c3 ) ) * d4 / e5 -> PREFIXA
INFIXA ( a1 + ( b2 - c3 ) ) * ( d4 / e5 ) -> PREFIXA
INFIXA ( c and d ) and ( a and b ) -> PREFIXA
INFIXA c and d and a and b -> PREFIXA
INFIXA not ( c and d ) and not ( a and b ) -> PREFIXA
INFIXA not not ( c and d ) and not not ( a and b ) -> PREFIXA
INFIXA not c and not d and not a and not b -> PREFIXA
INFIXA not not c and not not d and not not a and not not b -> PREFIXA
